...
public class DAL {
    ...
    public boolean insert(String nome, String email, Double longitude, Double latitude) {
    ...
    public boolean update(int id,String nome, String email, Double longitude, Double latitude) {
        ContentValues values;
        long result;
        String where = "_id = ?";
